...
const Integration = () => {
  return (
    <>
      <section className="relative py-20 lg:py-28 bg-gradient-to-b from-blue-50/30 to-transparent dark:from-gray-900">
        <div className="mx-auto max-w-7xl px-4 md:px-8">
          {/* Section Header */}
          <SectionHeader
            headerInfo={{
              title: "SEAMLESS INTEGRATIONS",
              subtitle: "Connect with Ecosystem",
              description:
                "Expand your shipping capabilities through our integrations with leading logistics services, payment gateways, and supply chain management tools.",
            }}
          />
